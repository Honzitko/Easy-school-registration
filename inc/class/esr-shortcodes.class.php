...
class ESR_Shortcodes {
	...
	// [esr_student_payment_page]
	public static function esr_student_payment_page_shortcode($attr) {
		//do_action('esr_load_external_scripts');
		ob_start();
		do_action('esr_print_student_payment_page', $_GET);
...
add_shortcode('esr_student_payment_page', ['ESR_Shortcodes', 'esr_student_payment_page_shortcode']);