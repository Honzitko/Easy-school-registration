	...
	public static function print_page() {
		...
		<div class="wrap esr-settings esr-teacher-info">
			...
			<div class="esr-settings-header esr-clearfix">
				<h2><?php _e('Teacher info', 'easy-school-registration'); ?></h2>
				<a class="esr-teacher-calendar-generation esr-download-button" href="#" data-wave-id="<?php echo $selected_wave; ?>" title="<?php _e('Download calendar', 'easy-school-registration'); ?>"><span class="dashicons dashicons-calendar-alt"></span></a>
			</div>
			<?php
