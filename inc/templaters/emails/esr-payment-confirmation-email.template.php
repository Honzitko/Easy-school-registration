...
class ESR_Template_Payment_Confirmation_Email {
	...
	public function send_email($wave_id, $email) {
		...
		$subject = stripcslashes(ESR()->settings->esr_get_option('payment_confirmation_email_subject'));
		$body    = stripcslashes(ESR()->settings->esr_get_option('payment_confirmation_email_body', null));
