...
class ESR_Course_Confirmation_Email_Templater {
	...
	public function send_email($registration_data) {
		...
		$subject = stripcslashes(ESR()->settings->esr_get_option('confirmation_email_subject'));
		$body    = stripcslashes(ESR()->settings->esr_get_option('confirmation_email_body', null));
