	...
	public static function print_page() {
		...
		<div class="wrap esr-settings esr-course-in-numbers">
			...
			<div class="esr-settings-header esr-clearfix">
				<h2><?php _e('Student info', 'easy-school-registration'); ?></h2>
				<a class="esr-student-download-button" href="#" data-wave-id="<?php echo $selected_wave; ?>" title="<?php _e('Download Calendar', 'easy-school-registration'); ?>"><span class="dashicons dashicons-calendar-alt"></span></a>
			</div>
			<?php
