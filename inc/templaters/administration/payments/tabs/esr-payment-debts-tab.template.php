...
class ESR_Tab_Template_Payment_Debts {
	...
	public static function esr_print_debts($selected_wave) {
		...
		?>
		<h1 class="wp-heading-inline"><?php _e('Debts', 'easy-school-registration'); ?></h1>
		<?php
		if ($user_can_edit) {
		...
		<table id="datatable" class="esr-datatable table table-default table-bordered esr-payments-table esr-email-export esr-copy-table esr-excel-export">
			...
			<tr>
				...
				<?php } ?>
				<th><?php _e('Student Name', 'easy-school-registration') ?></th>
				<th class="esr-student-email"><?php _e('Student Email', 'easy-school-registration') ?></th>
				<th class="no-sort"><?php _e('Wave', 'easy-school-registration') ?></th>
				<th class="no-sort"><?php _e('Payment Type', 'easy-school-registration') ?></th>
			...
			<tr class="<?php echo implode(' ', $classes); ?>"
				<?php if ($user_can_edit) { ?>
					...
					data-user_id="<?php echo $user_payment->user_id; ?>"
			...
			>
				...
				<td><?php echo $user_payment->title; ?></td>
		...
		<ul class="esr-actions-box dropdown-menu" data-id="<?php echo $user_payment->id; ?>">
			...
			<li class="esr-action disable-registration">
				<a href="javascript:;">
					...
					<span><?php _e('Disable Registrations', 'easy-school-registration'); ?></span>
				</a>
			</li>
			<li class="esr-action enable-registration">
				<a href="javascript:;">
					<span class="dashicons dashicons-unlock"></span>
					<span><?php _e('Enable Registrations', 'easy-school-registration'); ?></span>
				</a>
			</li>
