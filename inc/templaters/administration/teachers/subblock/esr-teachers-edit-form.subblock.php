...
class ESR_Teachers_Edit_Form_Subblock_Templater {
	...
	public function print_content() {
		...
		<div id="esr-edit-box" class="esr-edit-box">
			...
			<form action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="post">
				<h3><?php _e('Main Info', 'easy-school-registration'); ?></h3>
				<table>
					<colgroup>
						<col width="110">
						<col width="250">
	...
	public static function input_full_name() {
		?>
		<tr>
			<th><?php _e('Full Name', 'easy-school-registration'); ?></th>
	...
	public static function input_description() {
		?>
		<tr>
			<th><?php _e('Description', 'easy-school-registration'); ?></th>
	...
	public static function input_nickname() {
		?>
		<tr>
			<th><?php _e('Nickname', 'easy-school-registration'); ?></th>
			<td><input type="text" name="nickname" value="" data-name="nickname">
            <?php ESR_Tooltip_Templater_Helper::print_tooltip(__('Teacher nicknames are displayed in the Registration Form.', 'easy-school-registration')); ?>
            </td>
		</tr>
		<?php
	}
	...
	public static function input_teacher_settings() {
		?>
		<tr>
			<th><?php _e('Limit Registration View', 'easy-school-registration'); ?></th>
			<td><input type="checkbox" name="teacher_settings[limit_registrations]" value="1" data-name="limit_registrations">
				<?php ESR_Tooltip_Templater_Helper::print_tooltip(__('If selected, this Teacher will see only students who registered to his classes in the Registration section. The System User in the dropdown list above needs to be assigned.', 'easy-school-registration')); ?>
			</td>
		</tr>
		<?php
	}
	...
	public static function input_user() {
		...
		?>
		<tr>
			<th><label for="user_id"><?php _e('System User', 'easy-school-registration'); ?></label></th>
			<td>
                ...
                <?php ESR_Tooltip_Templater_Helper::print_tooltip(__('If you want to use the Limit Registration View function, the Teacher needs to be a WordPress user.', 'easy-school-registration')); ?>
			</td>
		</tr>
		<?php
	}
	...
	public static function input_submit() {
		...
		<tr>
			...
			<td>
				...
				<input type="submit" name="esr_save_teacher" value="<?php _e('Save', 'easy-school-registration'); ?>">
			</td>
		</tr>
		<?php
	}
