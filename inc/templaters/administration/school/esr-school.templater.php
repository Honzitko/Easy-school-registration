...
class ESR_Templater_School
{
	...
	public static function print_page()
	{
		...
		<div class="wrap esr-settings">
			...
			<p><?php echo sprintf(__('Check the <strong><a href="%s" target="_blank">Documentation</a></strong> or let us know via <strong><a href="%s" target="_blank">Contact form</a></strong>.', 'easy-school-registration'), 'https://easyschoolregistration.com/docs', 'https://easyschoolregistration.com/contact/'); ?></p>
