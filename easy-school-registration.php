 ...
 * Plugin Slug:     esr
 *
 * @copyright       Copyright © 2019 Easy School Registration
 */
...
if ( ! class_exists( 'Easy_School_Registration' ) ) {
	...
	final class Easy_School_Registration {
		...
		private function setup_constants() {
			...
			if ( ! defined( 'ESR_SL_STORE_URL' ) ) {
				define( 'ESR_SL_STORE_URL', 'https://easyschoolregistration.com' );
			}
			if ( ! defined( 'ESR_SL_ITEM_ID' ) ) {
				define( 'ESR_SL_ITEM_ID', 54 );
			}
		}
		...
		private function includes() {
			...
			require_once ESR_PLUGIN_PATH . '/inc/class/esr-licence.class.php';
			require_once ESR_PLUGIN_PATH . '/inc/class/esr-license-handler.class.php';
			...
			require_once ESR_PLUGIN_PATH . '/inc/install.php';
		...
		public function load_textdomain() {
			...
			$mofile_global = WP_LANG_DIR . '/easy-school-registration/' . $mofile;
                       ...
                       if ( file_exists( $mofile_global ) ) {
                               ...
                               return load_plugin_textdomain( 'easy-school-registration', false, dirname( plugin_basename( ESR_PLUGIN_FILE ) ) . '/languages/' );
                       }
		}
...
$license_key = trim( ESR()->settings->esr_get_option( 'license_key' ) );

// setup the updater

$edd_updater = new ESR_SL_Plugin_Updater( ESR_SL_STORE_URL, ESR_PLUGIN_FILE, [
	'version'   => ESR_VERSION,        // current version number
	'license'   => $license_key,    // license key (used get_option above to retrieve from DB)
	'item_name' => 'Easy School Registration',
	'item_id'   => ESR_SL_ITEM_ID,    // id of this product in ESR
